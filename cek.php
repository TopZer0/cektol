...
$detail_voucher = curl('https://api.gojekapi.com/gopoints/v3/wallet/vouchers?limit=10&page=1', null, $header);
 ...
 $nama_voucher15 = $vouchers->data[15]->title;
 $batas_voucher15 = $vouchers->data[15]->expiry_date;
 $nama_voucher16 = $vouchers->data[16]->title;
 $batas_voucher16 = $vouchers->data[16]->expiry_date;
 $nama_voucher17 = $vouchers->data[17]->title;
 $batas_voucher17 = $vouchers->data[17]->expiry_date;
 $nama_voucher18 = $vouchers->data[18]->title;
 $batas_voucher18 = $vouchers->data[18]->expiry_date;
 $nama_voucher19 = $vouchers->data[19]->title;
 $batas_voucher19 = $vouchers->data[19]->expiry_date;
 $nama_voucher20 = $vouchers->data[20]->title;
 $batas_voucher20 = $vouchers->data[20]->expiry_date;
 $nama_voucher21 = $vouchers->data[21]->title;
 $batas_voucher21 = $vouchers->data[21]->expiry_date;
 $nama_voucher22 = $vouchers->data[22]->title;
 $batas_voucher22 = $vouchers->data[22]->expiry_date;
 $nama_voucher23 = $vouchers->data[23]->title;
 $batas_voucher23 = $vouchers->data[23]->expiry_date;
 $nama_voucher23 = $vouchers->data[24]->title;
 $batas_voucher23 = $vouchers->data[24]->expiry_date;
...
";
        echo "
";
        echo 'Voucher : ' . $nama_voucher15 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher15 . '
';
        echo "
";
    } else {
...
';
 ...
 ";       
        echo "
";
        echo 'Voucher : ' . $nama_voucher16 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher16 . '
';
        echo "
";
    } else {
...
";  
        echo "
";
        echo 'Voucher : ' . $nama_voucher17 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher17 . '
';
        echo "
 ";
    } else {
...
';
 ...
 ";  
        echo "
";
        echo 'Voucher : ' . $nama_voucher18 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher18 . '
';
        echo "
";
    } else {
...
';
 ...
 ";  
        echo "
";
        echo 'Voucher : ' . $nama_voucher19 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher19 . '
';
        echo " 
 ";
    } else {
...
';
        echo " 
 ";
        echo 'Voucher : ' . $nama_voucher20 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher20 . '
';
        echo " 
 ";
    } else {
...
';
        echo " 
  ";
        echo 'Voucher : ' . $nama_voucher21 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher21 . '
';
        echo "  
 ";
    } else {
...
';
        echo "   
 ";
        echo 'Voucher : ' . $nama_voucher22 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher22 . '
';
        echo "   
 ";
    } else {
...
';
        echo " 
 ";
        echo 'Voucher : ' . $nama_voucher23 . '';
        echo "
";
        echo 'Kadaluarsa : ' . $batas_voucher23 . '
';
        echo "  
  }
  }
